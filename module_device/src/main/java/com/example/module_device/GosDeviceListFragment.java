    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case TOAST:
                    Toast.makeText(getContext(), msg.obj.toString(), LENGTH_LONG).show();
                    break;
                                ...
                                public void onClick(View arg0) {
                                    ...
                                    if (TextUtils.isEmpty(ps) || ps.length() != 32) {
                                        Toast.makeText(getContext(),
                                                getResources().getString(R.string.psiserror), LENGTH_LONG).show();
                                    } else {
...
//                           device.setSubscribe(null, true);
    ...
    protected void didUnbindDevice(GizWifiErrorCode result, String did) {
        ...
        if (GizWifiErrorCode.GIZ_SDK_SUCCESS != result) {
            ...
            Toast.makeText(getContext(), toastError(result), LENGTH_LONG).show();
        }
    }
    ...
    protected void didBindDevice(int error, String errorMessage, String did) {
        ...
        if (error != 0) {
            ...
            Toast.makeText(getContext(), R.string.bound_successful, LENGTH_LONG).show();
        }
    ...
    protected void didBindDevice(GizWifiErrorCode result, String did) {
        ...
        if (result != GizWifiErrorCode.GIZ_SDK_SUCCESS) {
            ...
            Toast.makeText(getContext(), R.string.add_successful, LENGTH_LONG).show();
        }
    }
    ...
    private void addDevice() {
        if (GosDeploy.appConfig_Config_Softap()) {
            if (!checkNetwork(getContext())) {
                Toast.makeText(getContext(), R.string.network_error, LENGTH_LONG).show();
                return;
            }
